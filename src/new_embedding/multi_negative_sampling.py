...
class NodeEmbedding(object):
    def __init__(self, params, init_embeddings, init_weights, unigrams_in = None, unigrams_out = None, num_new = 1):
    ...
    def train(self, get_batch, save_path = None):
        ...
        with tf.Session(graph = self.tensor_graph) as sess:
            ...
            for i in xrange(self.epoch_num):
                batch_x_in, batch_x_out, batch_labels_in, batch_labels_out = get_batch(self.batch_size)
                self.train_step.run({
