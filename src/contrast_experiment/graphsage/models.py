...
class SampleAndAggregate(GeneralizedModel):
    ...
    def __init__(self, placeholders, features, adj, degrees,
            ...
            model_size="small", identity_dim=0,num_nodes=None,
            **kwargs):
        '''
        Args:
        ...
        if features is None: 
            ...
            if not num_nodes is None:
                self.features = self.features[:num_nodes]
                self.features = tf.concat([self.features, tf.zeros([1, features.shape[1]], dtype=float32)], 0)
